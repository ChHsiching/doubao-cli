/* @meta
{
  "name": "doubao/translate",
  "description": "翻译文本 (doubao translate: translate text between languages)",
  "domain": "www.doubao.com",
  "args": {
    "message": {"required": true, "description": "翻译相关"}
  },
  "readOnly": false,
  "example": "bb-browser site doubao/translate 你的消息"
}
*/
async function(args) {

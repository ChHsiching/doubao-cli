...
{
  "name": "doubao/ppt",
  "description": "豆包PPT生成 (doubao ppt: generate presentations)",
  "domain": "www.doubao.com",
  "args": {
    "message": {"required": true, "description": "PPT生成需求"}
  },
  "readOnly": false,
  "example": "bb-browser site doubao/ppt 你的消息"
}
*/
async function(args) {
